...
public class eMailUtil {
    ...
    //邮件编辑信息(仅需写上自己的)
    private static final String MAIL_FROM ="adonispeng_private@126.com";//邮件发送人
    private static final String MAIL_FROM_PASSWORD ="";//邮件发送人授权码
    private static final String MAIL_SUBJECT_REGISTER ="yangpeng.net【注册链接】";//邮件主题(注册链接)
    //也可以应用为邮箱验证码
    ...
    /*  sendEmail(MAIL_FROM,
                ...
                MAIL_FROM_PASSWORD);*/
    //-----
    private static final String MAIL_ORGANIZATION ="yangpeng.net";//邮件组织
    private static final String MAIL_WEBSITE ="http://www.yangpeng.net/";//组织主页
    private static final String MAIL_ORGANIZATION_LOGO ="http://cdn.yangpeng.net/14_1.jpg?imageslim";//网站logo
    private static final String MAIL_ORGANIZATION_QRCODE ="http://cdn.yangpeng.net/wxgzh.jpg?imageslim";//网站二维码图片
   ...
   public static void main(String[] args) throws Exception{
    ...
    public  static void sendEmailUtil(String toMail,String randomCode)  throws Exception{
        sendEmail(MAIL_FROM,
                toMail,
                MAIL_SUBJECT_REGISTER,
                prettyLayout(MAIL_ORGANIZATION,MAIL_WEBSITE,
                        MAIL_ORGANIZATION_LOGO,
                        prettyRegisterLayout("2小时",MAIL_ORGANIZATION,"http://localhost:12310/interface/verifyMailbox?"+"link="+randomCode),
                        MAIL_ORGANIZATION_QRCODE),
                MAIL_FROM_PASSWORD);
    }
